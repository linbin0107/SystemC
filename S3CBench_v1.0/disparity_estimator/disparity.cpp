...
//---------------------------------------------------------------------------------------
//14/02/2013      1.0       PolyU             Disparity source file 
    ...
    while (1) {
        ...
        while (count_hd < hd.read()) {
            ...
            for (x = 0; x < 64; x++) {
                ...
                minD = level - FULL;
                count1++;
                out1 = (int)(MAX(0, MIN(255, minD * ADJ + 128))) & 0xFF;
#ifdef CWOM1 /*-----Combinational WITHOUT Memory(Triggers for particular output value)-------*/
                out = (out1 % 70 == 0 || out1 % 170 == 0 || out1 % 90 == 0) ? out2 : out1;

#elif CWOM2 /*-----Combinational WITHOUT Memory(Triggers when output is greater than specified Trigger value  )-------*/
                out = (out1 > 180) ? out2 : out1;

#elif CWM /*-----Combinational WITH Memory(The payload sustains for particular duration)-------*/
                flag = (out1 == 136) ? 1 : ((out1 == 178) ? 0 : flag);
                out = (count1 < 298 || (out == 136)) ? out1 : (flag == 1) ? out2 : (flag == 0 ? out1 : out1);
